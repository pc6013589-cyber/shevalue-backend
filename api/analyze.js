...
function directRuleAnalysis(message, relationshipStatus) {
  ...
  if (isJustMet && asksToComeOver) {
    return {
      ...
      pattern_detected: "Trying to get quick access without effort, planning, or proper intention",
      risk_level: "high",
      suggested_reply:
        "I don’t do house invites with someone I’ve just met. If your intentions are genuine, you can plan something respectful.",
    };
  }
  ...
  if (asksForPicture && guiltTrip) {
    return {
      ...
      pattern_detected: "Using guilt and pressure to demand emotional or visual reassurance",
      risk_level: "high",
      suggested_reply:
  ...
  if (scarcityManipulation && isEx) {
    return {
      ...
      pattern_detected: "Using fear and scarcity to regain emotional control",
      risk_level: "high",
      suggested_reply:
  ...
  if (scarcityManipulation) {
    return {
      ...
      pattern_detected: "Trying to make you doubt your value and options",
      risk_level: "high",
      suggested_reply:
  ...
  if (asksForPicture) {
    return {
      ...
      pattern_detected: "Requesting proof of care instead of communicating respectfully",
      risk_level: "high",
      suggested_reply:
  ...
  if (guiltTrip) {
    return {
      ...
      pattern_detected: "Using emotional pressure instead of direct, healthy communication",
      risk_level: "medium",
      suggested_reply:
